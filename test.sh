...
assert 30 'int main(){return +20-(-10);}'
assert 0 'int main(){return (1+4*5) >= 20 == 0;}'

assert 9 'int main(){int a;int b;a = 1;b = a * 3;return a = b * 3;}'
...
assert 11 'int main(){return foo(34, 23);}'
